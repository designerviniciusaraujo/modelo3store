    ...
    magicZoomFC: function(id, novoArray, novoArrayAmp, FC_MaxImages, refreshZoom){
      ...
      for (var i=0;i<=FC_MaxImages;i++)
      {
        if(i===0)
        {
          ...
          sHtmlZoom+="<a href="+imgAmpMini+" title=\""+ fn.getNameProduct().replace(/[\\"]/g,"") +"\" class=MagicZoomPlus id=zoom2 rel=\"selectors-class:active; zoom-width:350px; zoom-height:350px; selectors-change:mouseover\"><img src="+ imgDetMini +"></a><br>"
